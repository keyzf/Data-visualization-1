...
.left_b{
    ...
    .charts_l{
        width:vh(676);
        height:100%;
        background url('../../../../../static/images/truckHomeData/8_icon.png') no-repeat
    ...
    .charts_r{
        width:vh(676);
        height:100%;
         background url('../../../../../static/images/truckHomeData/9_icon.png') no-repeat
        -webkit-background-size 100% 100%
        background-size 100% 100%
        padding pxtovh(47) pxtovh(15) pxtovh(15) pxtovh(15)
    }
}
</style>
