<template>
  <div class="turnoverAnalysisIndex">
    ...
    <div class="main-content clearfix">
        <topCom v-if="status && isShow" :cityCode="cityCode"></topCom>
        <centerCom v-if ="status  && isShow" :cityCode="cityCode"></centerCom>
        <bottomCom v-if ="status && isShow" :cityCode="cityCode"></bottomCom>
    </div>
  </div>
</template>
...
export default {
  ...
  created () {
    window.document.title = '非油品营业额分析大屏'
