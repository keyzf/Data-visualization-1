  ...
  <div class="map-wrapper">
    ...
    <div class="detail-warpper">
      <div class="num-cont">
        ...
        <ul>
          <li class="liFirst"><img class="img_icon" src="https://img.gdoil.cn/cockpit/static/images/netDevelop2/build_icon.png" alt=""> 建设中:<span class="num"> {{buildingNum}} </span>座站</li>
...
.map-wrapper {
  ...
  width: 100%
  height: vh(758)
  background: url("https://img.gdoil.cn/cockpit/static/images/netDevelop/bg5.png") no-repeat
  -webkit-background-size: 100% vh(758)
  background-size: 100% vh(758)
  padding: vh(3) 0
  position relative
  .content {
