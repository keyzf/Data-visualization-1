...
.pie-wrapper {
  ...
  background: url("https://img.gdoil.cn/cockpit/static/images/netDevelop/bg1.png") no-repeat
  -webkit-background-size: 100% pxtovh(301)
  background-size: 100% pxtovh(301)
