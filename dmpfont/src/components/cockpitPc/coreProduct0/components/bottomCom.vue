<template>
  <div class="bottomCom igs-flex igs-flex4">
     <div class="topLeft">
        <listCommon :topList ="lubricatingOil" :bgImg="bgImg1"></listCommon>
    </div>
     <div class="topCenter">
        <listCommon :topList ="chineseWolfberry" :bgImg="bgImg2"></listCommon>
    </div>
     <div class="topRight">
        <listCommon :topList ="bathOfGlass" :bgImg="bgImg3"></listCommon>
    </div>
  </div>
</template>
...
export default {
  name: 'bottomCom',
  props: ['lubricatingOil', 'chineseWolfberry', 'bathOfGlass'],
  data () {
    return {
      topList1: [],
      topList2: [],
      topList3: [],
      bgImg1: 'https://img.gdoil.cn/cockpit/static/images/nonFuel/3/7.png',
      bgImg2: 'https://img.gdoil.cn/cockpit/static/images/nonFuel/3/8.png',
      bgImg3: 'https://img.gdoil.cn/cockpit/static/images/nonFuel/3/9.png'
    }
  },
  created () {
  },
