<template>
  <div class="centerCom igs-flex igs-flex4">
     <div class="topLeft">
        <listCommon :topList ="tianquanChangbaiMountain" :bgImg="bgImg1"></listCommon>
    </div>
     <div class="topCenter">
        <listCommon :topList ="laimaoWine" :bgImg="bgImg2"></listCommon>
    </div>
     <div class="topRight">
        <listCommon :topList ="moonDew" :bgImg="bgImg3"></listCommon>
    </div>
  </div>
</template>
...
export default {
  name: 'centerCom',
  props: ['tianquanChangbaiMountain', 'laimaoWine', 'moonDew'],
  data () {
    return {
      topList1: [],
      topList2: [],
      topList3: [],
      bgImg1: 'https://img.gdoil.cn/cockpit/static/images/nonFuel/3/4.png',
      bgImg2: 'https://img.gdoil.cn/cockpit/static/images/nonFuel/3/5.png',
      bgImg3: 'https://img.gdoil.cn/cockpit/static/images/nonFuel/3/6.png'
    }
  },
  created () {
  },
