...
export default {
  ...
  created () {
    window.document.title = '经营部核心商品排行榜'
  ...
  methods: {
    ...
    handleChange (value) {
      this.cityCode = value
      this.coreProductRankingArrayList()
    },
    // 获取地市的接口
    ...
    // 接口名称 ：Post /CoreProductRanking/coreProductRankingArrayList核心商品排行榜
    ...
    coreProductRankingArrayList () {
      let that = this
      this.$dialog.loading.open('加载中')
      that.$http.post('/webapi/bdview/CoreProductRanking/coreProductRankingArrayList', {
