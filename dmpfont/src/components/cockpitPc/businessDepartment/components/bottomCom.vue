...
export default {
  ...
  data () {
    return {
      ...
      topList2: [],
      topList3: [],
      bgImg1: 'https://img.gdoil.cn/cockpit/static/images/nonFuel/4/7.png',
      bgImg2: 'https://img.gdoil.cn/cockpit/static/images/nonFuel/4/8.png',
      bgImg3: 'https://img.gdoil.cn/cockpit/static/images/nonFuel/4/9.png'
    }
  },
  created () {
  },
