...
export default {
  ...
  data () {
    return {
      ...
      topList2: [],
      topList3: [],
      bgImg1: 'https://img.gdoil.cn/cockpit/static/images/nonFuel/4/4.png',
      bgImg2: 'https://img.gdoil.cn/cockpit/static/images/nonFuel/4/5.png',
      bgImg3: 'https://img.gdoil.cn/cockpit/static/images/nonFuel/4/6.png'
    }
  },
  created () {
  },
