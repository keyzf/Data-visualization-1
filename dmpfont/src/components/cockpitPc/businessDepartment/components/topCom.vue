...
export default {
  ...
  data () {
    return {
      ...
      topList2: [],
      topList3: [],
      bgImg1: 'https://img.gdoil.cn/cockpit/static/images/nonFuel/4/1.png',
      bgImg2: 'https://img.gdoil.cn/cockpit/static/images/nonFuel/4/2.png',
      bgImg3: 'https://img.gdoil.cn/cockpit/static/images/nonFuel/4/3.png'
    }
  },
  created () {
  },
