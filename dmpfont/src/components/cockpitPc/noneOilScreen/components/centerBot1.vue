...
export default {
  ...
  methods: {
    ...
    monthlySalesMiddleClassRankTop () {
      this.$http.post('/webapi/bdview/notOilDataBS/monthlySalesMiddleClassRankTop').then(res => {
        if (res.result === true) {
          let json = res.rows
          // 降序处理
          json.sort((a, b) => {
    ...
    monthlySalesSmallClassRankTop () {
      this.$http.post('/webapi/bdview/notOilDataBS/monthlySalesSmallClassRankTop').then(res => {
        if (res.result === true) {
          let json = res.rows
          // 降序处理
          json.sort((a, b) => {
    ...
    monthlySalesSingleProductRankTop () {
      this.$http.post('/webapi/bdview/notOilDataBS/monthlySalesSingleProductRankTop').then(res => {
        if (res.result === true) {
          let json = res.rows
          // 降序处理
          json.sort((a, b) => {
